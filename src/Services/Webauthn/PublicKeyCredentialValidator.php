...
use Pschocke\LaravelWebauthn\Exceptions\ResponseMismatchException;
...
final class PublicKeyCredentialValidator extends AbstractValidatorFactory
{
     ...
     * @throws ResponseMismatchException
     */
    public function check(WebauthnCredentiable  $model, PublicKeyCredentialRequestOptions $publicKeyCredentialRequestOptions, string $data): bool
    {
        $coseAlgorithmManager = $this->getCoseAlgorithmManager();
